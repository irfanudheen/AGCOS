(function ($) {
  ...
  // Date Picker
  if ($(".AGCOS-datepicker").length) {
    $(".AGCOS-datepicker").each(function () {
      $(this).datepicker();
    });
  }
  ...
  //accrodion
  if ($(".AGCOS-accrodion").length) {
    var accrodionGrp = $(".AGCOS-accrodion");
  ...
  function thmOwlInit() {
    // owl slider
    let AGCOSowlCarousel = $(".AGCOS-owl__carousel");
    if (AGCOSowlCarousel.length) {
      AGCOSowlCarousel.each(function () {
        let elm = $(this);
    ...
    let AGCOSowlCarouselNav = $(".AGCOS-owl__carousel--custom-nav");
    if (AGCOSowlCarouselNav.length) {
      AGCOSowlCarouselNav.each(function () {
        let elm = $(this);
  ...
  function AGCOSSlickInit() {
    // slick slider
    let AGCOSslickCarousel = $(".AGCOS-slick__carousel");
    if (AGCOSslickCarousel.length) {
      AGCOSslickCarousel.each(function () {
        let elm = $(this);
        let options = elm.data("slick-options");
        let AGCOSslickCarousel = elm.slick(
          "object" === typeof options ? options : JSON.parse(options)
        );
      });
    }
  ...
  //Strech Column
  function AGCOS_stretch() {
    var i = $(window).width();
    $(".row .AGCOS-stretch-element-inside-column").each(function () {
      var $this = $(this),
